...
@Component({
  styleUrl: 'epi-report-selector.scss',
  tag: 'epi-report-selector',
})
export class EpiReportSelector {
  ...
  selectThingHandler() {
    ...
    document.querySelectorAll('.epi-filtered-datastream').forEach((stream: any) => {
